...
###############################################################################################
	...
	if delete_database == True:			
		try:
			delete_data(dest_conn, dest_schema, dest_table)

			copy_data(dest_conn, accessKey, secretKey,
					   dataStagingPath,
